...
class EditList01 extends StatefulWidget {
  final Post post;
  const EditList01(this.post);

  @override
  State<EditList01> createState() => _EditList01State();
}

class _EditList01State extends State<EditList01> {
  File? image01;
  File? image02;
  File? image03;
  File? image04;
                      ...
                      child: ElevatedButton(
                          onPressed: () async {
                            if (titleController.text.isNotEmpty) {
                              ...
                              if (image01 != null) {
                                var editImage01 = await Register.EditImageFromGallery(
                                    widget.post.tableId, "1", image01!);
