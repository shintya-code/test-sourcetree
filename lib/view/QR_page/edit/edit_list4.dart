...
class EditList04 extends StatefulWidget {
  final Post post;
  ...
  @override
  State<EditList04> createState() => _EditList04State();
}

class _EditList04State extends State<EditList04> {
  File? image01;
  File? image02;
  File? image03;
  File? image04;
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: image04 == null ? BoxDecoration(
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(widget.post.imagePath4!)
                              )
                          ) : BoxDecoration(
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                      ...
                      child: ElevatedButton(
                          onPressed: () async{
                            if(titleController.text.isNotEmpty){
                              ...
                              if(image04 != null){
                                var editImage04 = await Register.EditImageFromGallery(widget.post.tableId,"4",image04!);
                                widget.post.imagePath4 = editImage04.toString();
                              }
