...
class AddListThird02 extends StatefulWidget {
  String selected;
  String titleName;
  AddListThird02(this.selected,this.titleName);

  @override
  State<AddListThird02> createState() => _AddListThird02State();
}

class _AddListThird02State extends State<AddListThird02> {
  File? image01;
  File? image02;
  File? image03;
  File? image04;
                    ...
                    onPressed: () async{
                      if(image01 != null){
                        if(image02 != null) {
                          ...
                          await Register.createPost2(result,image01,image02);
