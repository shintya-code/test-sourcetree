...
class AddListThird03 extends StatefulWidget {
  String selected;
  String titleName;
  AddListThird03(this.selected,this.titleName);

  @override
  State<AddListThird03> createState() => _AddListThird03State();
}

class _AddListThird03State extends State<AddListThird03> {
  File? image01;
  File? image02;
  File? image03;
  File? image04;
                      ...
                      if(image01 != null){
                        if(image02 != null) {
                          if(image03 != null){
                            ...
                            await Register.createPost3(result,image01,image02,image03);
